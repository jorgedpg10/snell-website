...
import { Apple, Smartphone, Globe, KanbanSquare, BugPlay, Workflow, ShieldCheck , Terminal } from "lucide-react";
import Bussiness from "../assets/bussiness.png";
import Web from "../assets/web2.png";
import Hacker from "../assets/hacker-azul.png";
...
export const Home = () => {
    ...
    {
      title: "Pentesting y Seguridad Ofensiva",
      description:
        "No seas la próxima vícitma en tiempos de Pandemia de Ciberseguridad",
      image: Hacker,
      reverse: true, // texto izq / imagen der
    },
    {
      title: "Zero Downtime",
      description:
      ...
      image: Web,
      reverse: false, // texto der / imagen izq
    },  
  ];
